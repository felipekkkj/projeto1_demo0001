...
export default function RadioButonBooleanValue({
  name,
  label,
  defaultValue,
  onChange,
  ...
  const hasViewValue = () => defaultValue === true || defaultValue === false;
...
RadioButonBooleanValue.propTypes = {
...
RadioButonBooleanValue.defaultProps = {
  defaultValue: false,
};
